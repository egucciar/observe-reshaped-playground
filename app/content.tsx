...
const reshapedComponents = [
  ...
  { key: 'autocomplete', label: 'Autocomplete', component: AutocompletePage },
  ...
  { key: 'numberfield', label: 'NumberField', component: NumberFieldPage },
  ...
  { key: 'textarea', label: 'TextArea', component: TextAreaPage },
  { key: 'textfield', label: 'TextField', component: TextFieldPage },
