...
export function FileUploadPage() {
  ...
  return (
    <View padding={4} gap={4}>
      ...
      <View gap={3}>
        <h2>File Upload with Custom Trigger</h2>
        <Card padding={4}>
      ...
      <View gap={3}>
        ...
        <Card padding={4}>
          <View gap={3}>
            <FileUpload name="image-upload" onChange={handleImageUpload}>
              <View gap={2} align="center">
      ...
      <View gap={3}>
        ...
        <Card padding={4}>
          <View gap={3}>
            <FileUpload name="document-upload" onChange={handleDocumentUpload}>
              <View gap={2} align="center">
      ...
      <View gap={3}>
        <h2>Compact Upload with Icon</h2>
        <Card padding={4}>
        ...
        <Card padding={4}>
          <View direction="row" gap={4} align="center">
            ...
            <View gap={2}>
              ...
              <FileUpload name="profile-pic" onChange={handleImageUpload} inline>
                <FileUpload.Trigger>
                  <Button variant="outline" size="small">
                    Upload Photo
                  </Button>
          ...
          >
            <View gap={3}>
              <View gap={2}>
                ...
                <TextField name="project-name" placeholder="Enter project name" />
              </View>
              <View gap={2}>
